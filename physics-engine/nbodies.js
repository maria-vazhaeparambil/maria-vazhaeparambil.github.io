...
function findWasmBinary() {
    return locateFile('nbodies.wasm');
}
...
var ASM_CONSTS = {
 ...
 141922: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 142005: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 142074: () => { return window.innerWidth; },  
 142104: () => { return window.innerHeight; }
};
